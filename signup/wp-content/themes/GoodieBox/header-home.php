...
<!--<![endif]-->
<head>
	<meta name="description" content="Meglepetés csomag kutyusodnak minden hónapban"/>
	<meta name="keywords" content="goodiebox,rágcsálnivaló, jutalomfalatkák, játék, kiegészíto, design cucc" />
...
var obj = {method: 'feed',link: 'http://goodiebox.hu/', picture: 'http://goodiebox.hu/logo.jpg',name: 'Goodiebox',description: 'Meglepet&#233;s csomag kutyusodnak minden h&oacute;napban'};
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
          <div class="header-left">
            ...
            <h2 class="site-description">Meglepet&#233;s csomag kutyusodnak minden h&oacute;napban</h2>
          </div>
