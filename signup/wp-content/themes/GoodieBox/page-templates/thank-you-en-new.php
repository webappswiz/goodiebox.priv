<?php
/**
 * Template Name: Thank you Page ENG new
 *
 * @package WordPress
...
<table style="max-width:1020px" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    ...
    <div class="desc">Monthly surprise box of quality<br /> treats 'n toys for your dog.</div>
...
<script>
  ...
  <tr>
    <td height="80" align="center"><h1 class="page-title">Hello!</h1></td>
  </tr>
  <tr>
    <td><table width="70%" border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        ...
        <td width="100%" colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><strong>Your subscription was successfully confirmed. We have sent our first newsletter to your email address!</strong></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
         <tr>
                <td class="rows-2">You're on your way to receiving your first <strong>Goodiebox!</strong> Meanwhile, checkout our  <a href="https://www.facebook.com/goodieboxhu"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/thank/fb-icon.png" /></a> and <a href="https://www.twitter.com/goodieboxhu"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/thank/twt-icon.png" /></a> pages for more information!</td>
              </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
