...
$config = array(
	...
	'METHOD' => "",																			//payment method	 empty -> select payment method on PayU payment page OR [ CCVISAMC, WIRE, CASH, PAYU_MOBILE ]
	'ORDER_DATE' => date("Y-m-d H:i:s"),													//date of transaction
	'LOGGER' => true,																		//transaction log
	'LOG_PATH' => 'log',																	//path of log file
	'BACK_REF' => 'http://'.$_SERVER['HTTP_HOST'].'/payu/backref.php',						//url of payu payment backref page
