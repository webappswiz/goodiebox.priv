...
<section id="faq" class="rounded">
    ...
    <div id="collapse-content">
        ...
        <div>
            <div class="content">
                A Goodiebox egy egyedülálló szolgáltatás, Magyarország legcukibb meglepetés doboza kutyusoknak! Ha szeretnéd meglepni kedvencedet, akkor a lehető legjobb helyen jársz! 
				<br /><br />
				Jelenleg két dobozunk elérhető; a Goodiebox Smart és a Goodiebox Plus. A dobozok tartalma minden hónapban változik, így érdemes mindig visszalátogatni hozzánk, vagy praktikusan előrendelni, így kényelmesen várhatjátok az aktuális dobozt az otthonotokban!
            </div>
        </div>
        ...
        <div>
            <div class="content">
                Saját kutyusnak a "Megrendelem" gomb megnyomásával indul a vásárlás folyamata. <br/><br/>
...
A második lépésben a periódust tudod kiválasztani, amivel jelzed nekünk, melyik dobozt kéred (Goodiebox Smart vagy Goodiebox Plus), és szeretnéd-e előrendelni. <br/><br/>
...
Azonnali bankkártyás fizetés esetén automatikusan a PayU biztonságos felületre navigálunk és a bankkáryta adataid kitöltésével rendelhetsz. Mint szolgáltató, mi semmilyen a bankkártyádra vonatkozó adatot nem tárolunk. Ilyen esetben többlet költség nem kerül felszámításra. <br/><br/>

Utánvételes fizetés esetén a Megrendelem gombra kattintva elfogadod, hogy a csomag átvételekor fogsz fizetni készpénzben. Ebben az esetben többlet költséget számolunk fel, melynek összegét minden esetben jelezzük neked, amikor kiválasztod ezt a fizetési lehetőséget. <br/><br/>
...
FONTOS! Amennyiben nem kapod meg az üzeneteket 24 órán belül, mindenképpen jelezd felénk a <a href="mailto:rendeles@goodiebox.hu">rendeles@goodiebox.hu</a> email címen! Köszönjük!
            </div>
        </div>
