...
<section class="contact" class="rounded">
    ...
    <div class="contact-cont-right">
        <ul>
            ...
            <li style="text-align: center"><a href="http://goodiebox.hu/signup"><button type="button" class="top-btn rounded" style="width:175px;">Feliratkozok<br>a hírlevélre!</button></a></li>
        </ul>
