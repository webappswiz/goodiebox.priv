...
<section class="process-2" class="rounded">
    ...
    <ul class="claim-option-list step2-list">
        ...
        foreach ($products as $product) {
            ...
            echo '<li style="border:1px solid"><img width="120" height="68" src="' . URL::base(TRUE, FALSE) . 'assets/img/step2-img' . $img . '.jpg"><input style="cursor: pointer" type="radio" class="" name="box" id="box" value="' . $product->id . '" required><label>' . $product->package_name . '</label><br/><br/><span class="price">' . $price.'</span>';
