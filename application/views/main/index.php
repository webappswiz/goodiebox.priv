...
<section id="order-place" class="rounded">
    ...
    <div class="order-btnleft">
        <a href="<?= ($status == 1) ? URL::base(TRUE, FALSE) . 'order/?smart' : '#' ?>">
            <button type="button" class="rounded" style="font-weight: bolder;width: 100px;">SMART</button>
        </a>
...
már 5990 Ft-tól!</p>
    ...
    <div class="order-btnright">
        <a href="<?= ($status == 1) ? URL::base(TRUE, FALSE) . 'order/?plus' : '#' ?>">
            <button type="button" class="rounded" style="font-weight: bolder;width: 100px;">PLUS</button>
        </a>
