...
You are receiving this notification because you are watching the forum "<?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?>" at "<?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>". This forum has received a new topic<?php if ($this->_rootref['AUTHOR_NAME'] !== ('')) {  ?> by <?php echo (isset($this->_rootref['AUTHOR_NAME'])) ? $this->_rootref['AUTHOR_NAME'] : ''; } ?> since your last visit, "<?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?>". You can use the following link to view the forum, no more notifications will be sent until you visit the forum.
