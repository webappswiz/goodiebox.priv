...
include($phpbb_root_path . 'includes/functions_sitesplat.' . $phpEx);

	$sql = $db->sql_build_query('SELECT_DISTINCT', array(
'SELECT'	=> 'u.user_id, u.username, u.username_clean, u.user_colour, MAX(s.session_time) as online_time, MIN(s.session_viewonline) AS viewonline, u.user_avatar, u.user_avatar_type, u.user_avatar_width, u.user_avatar_height',
...
'AVATAR'		=> sitesplat_user_avatar($row['user_avatar'], $row['user_avatar_type'], $row['user_avatar_width'], $row['user_avatar_height']),
